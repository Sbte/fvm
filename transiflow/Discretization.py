...
class Discretization:
    r'''Finite volume discretization of the incompressible Navier-Stokes
    equations on a (possibly non-uniform) Arakawa C-grid. After
    discretization, the incompressible Navier-Stokes equations can be
    writen as a system of ordinary differential equations with
    algebraic constraints (DAE) of the form
    ...
    def rhs(self, state):
        r'''Compute the right-hand side of the DAE. That is the right-hand side
        $F(u, p)$ in
    ...
    def jacobian(self, state):
        r'''Compute the Jacobian matrix $J(u, p)$ of the right-hand side of the DAE. That is the Jacobian matrix of $F(u, p)$ in
    ...
    def mass_matrix(self):
        r'''Compute the mass matrix of the DAE. That is the mass matrix $M(p)$ in
